...
export default {
  ...
  gd: {
    ...
    constitutionNote: "The group's rules: savings, shares, social fund, loans and fines. Changes apply to new records only.",
  ...
  rules: {
    ...
    cancel: 'Cancel',
    saved: 'Rules saved.',
    newRecordsOnly: 'Changes apply to new records only. Existing loans keep the interest and total they were issued with.',
    readOnly: 'Only the Mwenyekiti, a Super Admin or Operations staff can change these rules.',
    multiplier: 'Max loan (× savings + shares)',
    multiplierNone: 'No limit',
    multiplierHint: '0 = no limit',
    reason: 'Reason',
    amount: 'Amount (TZS)',
    addReason: '+ Add fine reason',
    remove: 'Remove',
    services: 'Services the group uses',
    loadFailed: 'Could not load the rules',
    loansTitle: 'Member loans',
    noLoans: 'No loans recorded yet.',
    loanNo: 'Loan #',
    member: 'Member',
    principal: 'Principal',
    ...
    issued: 'Issued',
    status: 'Status',
    legacyNote: 'Loans issued before interest was charged owe their principal only (no interest).',
    st: { active: 'Active', repaid: 'Repaid', defaulted: 'Defaulted', cancelled: 'Cancelled' }
  },
  mem: {
    title: 'Members',
